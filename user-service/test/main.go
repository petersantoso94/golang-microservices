...
import (
	...
	mysvccore "github.com/petersantoso94/golang-microservices/user-service/core"
	mysvcgrpc "github.com/petersantoso94/golang-microservices/user-service/grpc/client"
	"github.com/xiam/to"
)

func main() {
	var localService, grpcService user.Service
